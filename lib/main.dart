                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          'Home',
                        style: TextStyle(color: Colors.black, fontSize:17, fontFamily: 'Poppins', fontWeight:FontWeight.bold), 
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text("Top Rated Book", style: TextStyle(color: Colors.white, fontSize: 35, fontWeight: FontWeight.bold),),
                      SizedBox(height: 30,),
                      Container(
                        height: 50,
                        ...
                        child: Center(child: Text("View", style: TextStyle(color: Colors.grey[900], fontWeight: FontWeight.bold),)),
                      ),
                      SizedBox(height: 30,),
                    ],
                  ),
