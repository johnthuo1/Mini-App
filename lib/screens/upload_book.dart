...
// Get the user document from Firestore using the user UID
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
      ...
      _borrowedController.text = _borrowed ? 'true' : 'false';
      setState(() {});
    });
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Has the book been borrowed?';
                      }
                      return null;
                    },
                  ),
                  ...
                  TextFormField(
                    ...
                    enabled: false, // Set this to disable editing
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                            ...
                            if (_formKey.currentState!.validate()) {
                              try {
                                ...
                                BookModel newBook = BookModel(
                                  ...
                                  borrowed: _borrowedController.text,
